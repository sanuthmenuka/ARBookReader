...
const StyledInputBase = styled(InputBase)(() => ({
  ...
  const CardMediaComponent = styled(CardMedia)(()=>({
   ...
   <AppBarWrapper>
      ...
      <Grid container   sx={{gap:{sx:1, lg:0}, display:{xs:"flex"},flex:{xs:'1 1 6vw',md:'1 1 50vw' , flexDirection:{xs:"row"} ,padding:{xs:'10px 20px'}}}}>
        <Grid item xs={2} sm={3}>
                   ...
                   <CardMediaComponent
                    ...
                    alt="green iguana" />
                      < CardContentComponent>
                        ...
                        <Typography color={pink[400]}> by {book.authors}</Typography>
                        <Box display="flex"
                        flexDirection="row"
                        spacing='2'
                        color={yellow[800]}
