...
import { Typography,useTheme,FormControlLabel,RadioGroup, Button,Box,Grid,TextField,InputLabel,MenuItem,Select,Radio,Checkbox} from "@mui/material";
 ...
 const OuterContainer = styled(Box)(() => ({
  ...
  const handleFormSubmit = (event) => {
    ...
    const formData = {
      ...
      ageCatogory : event.target.ageCatogory.value,
      genre : event.target.genre.value,
      ARcontent : event.target.ARcontent.value,
      description : event.target.description.value,
      tag1 :event.target.tag1.value,
      tag2 :event.target.tag2.value,
      coverImage : event.target.coverImage.files[0],
      uploadedBook : event.target.uploadedBook.files[0],
...
<Grid item>
          ...
          <Grid item >
          <InputLabel  id="ARcontent">Augmented Reality Content*</InputLabel>
          <RadioGroup   
            row // radio btns as a row
            name="ARcontent"
            defaultValue="No"
       ...
       <Grid container spacing={2} display={"flex"} flexDirection={"column"}>
          <Grid item >
            <InputLabel  marginBottom={'10px'}>Cover Image* {'('}.jpeg .png .jpg{')'}</InputLabel>
            <TextField
              label=""
            type="file"
          ...
          <Grid item >
            <InputLabel  marginBottom={'10px'}>Upload your book*   {'('}.pdf .epub{')'} </InputLabel>
            <TextField
            label=""
            type="file"
        ...
        <PublishBtn variant="contained" type="submit">  Publish</PublishBtn>
        </Box>
